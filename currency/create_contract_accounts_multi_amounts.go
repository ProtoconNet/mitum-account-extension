...
func NewCreateContractAccountsItemMultiAmounts(keys mitumcurrency.AccountKeys, amounts []mitumcurrency.Amount, addrType hint.Type) CreateContractAccountsItemMultiAmounts {
